...
.thread-header { display: flex; align-items: center; gap: 0.5rem; padding: 0.5rem 0.75rem; border-bottom: 1px solid var(--reader-border, var(--color-border, #e0e0e0)); }
.back-btn { background: none; border: none; cursor: pointer; font-size: 1rem; color: var(--reader-text-secondary, var(--color-text-secondary, #666)); }
...
.thinking { text-align: center; color: var(--reader-text-secondary, var(--color-text-secondary, #888)); font-style: italic; padding: 0.5rem; }
.input-area { padding: 0.5rem 0.75rem; border-top: 1px solid var(--reader-border, var(--color-border, #e0e0e0)); display: flex; gap: 0.5rem; align-items: flex-end; }
