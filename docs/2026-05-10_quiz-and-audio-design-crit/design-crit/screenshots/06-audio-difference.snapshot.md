        ...
        - tabpanel [ref=e62]:
          - generic [ref=e64]:
            ...
            - generic [ref=e69]:
              ...
              - dialog "What's the difference between engines?" [active] [ref=e72]:
                - heading "Kokoro vs. Web Speech" [level=3] [ref=e73]
                - paragraph [ref=e74]:
                  - strong [ref=e75]: Kokoro
                  - text: generates audio files on disk. You get full seek/scrub controls, a precise timestamp, and persistent resume across devices. Generation takes a few minutes per book.
                - paragraph [ref=e76]:
                  - strong [ref=e77]: Web Speech
                  - text: uses your browser's voice. Playback is instant, but you can't seek/scrub mid-sentence and there's no precise timestamp.
                - link "Open audio settings →" [ref=e79] [cursor=pointer]:
                  - /url: /settings/tts#audio
